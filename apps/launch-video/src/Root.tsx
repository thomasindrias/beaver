...
import { ReflexVertical } from "./scenes/reflex/ReflexVertical";
...
export const Root: React.FC = () => (
  <>
    ...
    <Composition id="ReflexVertical" component={ReflexVertical} durationInFrames={REFLEX_DURATION} fps={FPS} width={1080} height={1920} />
