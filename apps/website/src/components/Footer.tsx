...
export function Footer() {
  return (
    <footer className="mx-auto flex max-w-[1040px] flex-wrap justify-between gap-3 border-t-[2.5px] border-dashed border-ink px-6 pt-6 pb-11 text-caption font-semibold text-muted">
